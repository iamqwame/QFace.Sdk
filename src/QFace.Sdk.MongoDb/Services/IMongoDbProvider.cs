...
public interface IMongoDbProvider
{
    ...
    /// <returns>The MongoDB database</returns>
    IMongoDatabase GetTenantDatabase(string tenantId, string databaseNameFormat = "{0}_db");
    ...
    IMongoCollection<TDocument> GetCollection<TDocument>(string collectionName, string databaseName = null);
    ...
    /// <param name="databaseNameFormat">The database name format (default: {0}_db)</param>
    /// <returns>The MongoDB collection</returns>
    IMongoCollection<TDocument> GetTenantCollection<TDocument>(
        string tenantId, 
