...
public static class BlobStorageExtensions
{
            ...
            else
            {
                switch (provider)
                {
                    ...
                    case S3Provider.CloudflareR2:
                        throw new ArgumentException("ServiceURL is required for Cloudflare R2 provider");
                    case S3Provider.AWS:
    ...
    {
        if (string.Equals(providerString, "Cloudflare", StringComparison.OrdinalIgnoreCase) ||
            string.Equals(providerString, "R2", StringComparison.OrdinalIgnoreCase))
        {
            return S3Provider.CloudflareR2;
        }
